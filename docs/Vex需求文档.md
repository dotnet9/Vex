...
8. 验收时必须把剪贴板内容粘贴到微信公众号正文编辑器，确认不是显示原始 HTML 文本，而是按富文本结构正常渲染，并确认当前排版主题的标题色、正文色、链接色、边框色和代码块背景已生效。
...
5. 主题切换后，Markdown 预览、HTML/打印导出、PNG/PDF 图像型导出和“复制到公众号/知乎/稀土掘金”应使用同一套排版主题映射。
